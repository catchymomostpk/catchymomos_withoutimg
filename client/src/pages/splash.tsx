...
export default function SplashPage() {
  ...
  return (
    <div className="min-h-screen thick-red-black-gradient flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md mx-auto text-center text-white space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="text-4xl sm:text-5xl font-bold" data-testid="app-title">Catchy Momos</h1>
