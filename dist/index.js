...
var MongoStorage = class {
  ...
  inventoryItems;
  isConnected = false;
  constructor(connectionString, databaseName = "Catchymomos") {
  ...
  async initializeDefaultData() {
    ...
    if (!existingUser) {
      await this.createUser({ username: "Catchymomos", password: "Catchymomos@2025" });
    }
  ...
  async initializeCategories() {
    const defaultCategories = [
      ...
      { name: "MOCKTAIL'S", subCategories: [] },
      { name: "MOMO'S", subCategories: [] },
      { name: "SNACK'S", subCategories: [] }
    ];
  ...
  async initializeMenuItems() {
    const defaultItems = [
      // Mocktails
      {
        ...
        description: "Refreshing blend of mint, lime, and blue curacao.",
        price: "60.00",
        category: "MOCKTAIL'S",
      ...
      },
      {
        ...
        description: "Classic lemon and mint cooler.",
        price: "60.00",
        category: "MOCKTAIL'S",
        image: "https://images.unsplash.com/photo-1551538827-9c037cb4f32a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
        name: "Red Grape Mojito",
        description: "Sweet grape-infused mojito twist.",
        price: "60.00",
        category: "MOCKTAIL'S",
        image: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      // Momos
      {
        ...
        price: "60.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
      ...
      },
      {
        ...
        description: "Sweet momos stuffed with molten chocolate.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
        ...
        description: "Fresh paneer and veggie filling, delicately steamed.",
        price: "80.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
        ...
        description: "Crispy version of paneer momos.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
        ...
        description: "Fusion of pizza flavors in momos.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Paneer Tikka Momos (Spl)",
        description: "Spicy paneer tikka filling, grilled flavor.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Mushroom Momos",
        description: "Juicy mushroom-filled momos.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Veg Corn Cheese Momos (Spl)",
        description: "Sweet corn and melted cheese filling.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Pan Fried Veg Momos",
        description: "Crispy-bottomed pan-fried vegetable momos.",
        price: "120.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      },
      {
        ...
        description: "Crispy fried version of chicken momos.",
        price: "80.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "BBQ Chicken Momos",
        description: "Barbecue-flavored chicken momos.",
        price: "80.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
        ...
        description: "Pan-fried chicken dumplings with golden crust.",
        price: "140.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Peri Peri Chicken Momos (Spl)",
        description: "Tangy and spicy Peri Peri flavored momos.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      },
      {
        ...
        description: "Spicy Schezwan chicken momos.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Chicken Tikka Momos (Spl)",
        description: "Marinated chicken tikka filling.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Chicken Cheese Momos (Spl)",
        description: "Creamy chicken and cheese combination.",
        price: "90.00",
        category: "MOMO'S",
        image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
        available: true
      ...
      {
        name: "Veg Cutlet",
        description: "Crispy vegetable patties served with ketchup.",
        price: "50.00",
        category: "SNACK'S",
      ...
      {
        name: "French Fries",
        description: "Classic golden fries with salt and seasoning.",
        price: "50.00",
        category: "SNACK'S",
...
var MemStorage = class {
  ...
  constructor() {
    ...
    this.createUser({ username: "Catchymomos", password: "Catchymomos@2025" });
